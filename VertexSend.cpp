...
static void textureShit()
{
	glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, texPolar);
	glTexImage2D(GL_TEXTURE_2D, 0, 3, gqx, gqy, 0, GL_RGB, GL_UNSIGNED_BYTE, (void*)pgridc);
