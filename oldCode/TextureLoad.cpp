...
void LoadGLTextures()
{
	...
	TextureImage[6]=LoadBMP("Data/star.bmp");
	TextureImage[7]=LoadBMP("Data/pisinawall.bmp");
	TextureImage[8]=LoadBMP("Data/pisinafloor.bmp");
	TextureImage[9]=LoadBMP("Data/sky.bmp");
	TextureImage[10]=LoadBMP("Data/wall1.bmp");
